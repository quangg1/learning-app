...
class MainPage(ft.Container):
    ...
    def init_ui_intro_content(self):
        ...
        data_all_courses = CourseAPI.get_all_courses()
    ...
    def init_ui_all_lessons_of_courses(self):
        ...
        data_all_lessons = data_fetch.get('results') or []
        # data_all_lessons = data_fetch
        total_lessons = data_fetch.get('count')
        pagination = math.ceil((total_lessons or 0) / 10)

        print(data_all_lessons)
    ...
    def init_ui_all_detail_lessons_of_lesson(self):
        ...
        results = data_all_detail_lessons.get('results') or []
        count = data_all_detail_lessons.get('count')
        pagination = math.ceil((count or 0) / 10) if count else 1
